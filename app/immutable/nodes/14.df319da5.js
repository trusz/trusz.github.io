import{s as Ht,n as Sn}from"../chunks/scheduler.63274e7e.js";import{S as Lt,i as Mt,g as a,s as l,H as i,h as p,y as c,c as o,j as r,C as k,f as t,k as m,a as e}from"../chunks/index.f461cf18.js";function It(ft){let u,qn="UI Development in Docker",J,h,Fn=`Back in the day I have always struggled with setting up development environments for projects.<br/>
...
Furthermore, to run it one only needs Docker.`,tn,C,$n="The docker-compose file usually looks something like this:",sn,x,en,wt=`<code class="language-yaml"><span class="token comment"># An extract of the &#96;docker-compose.yaml&#96;</span>
...
This is necessary to see the UI itself when working on the styling.`,mn,I,Zn='Chromium has to be launched with <code>--enable-automation</code> so that the browser driver (<a href="https://github.com/puppeteer/puppeteer" rel="nofollow">Chrome Puppeteer</a>) can control it through websocket.',hn,E,nt="I usually have a shell script to do it, similar to this:",dn,j,yn,Ct=`<code class="language-sh"><span class="token assign-left variable">chromium</span><span class="token operator">=</span>/Applications/Chromium.app/Contents/MacOS/Chromium
...
making it seem like that they also runs on <code>localhost</code>.`,_n,R,at="The container also watches for file changes to re-run the tests.",Cn,S,pt="The container has to open its port for the browser.",xn,q,gn,xt=`<code class="language-yaml"><span class="token comment"># An extract of the &#96;docker-compose.yaml&#96;</span>
<span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">"3.6"</span>
<span class="token key atrule">services</span><span class="token punctuation">:</span>
